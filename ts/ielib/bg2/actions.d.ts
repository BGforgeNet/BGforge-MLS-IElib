...
```
 */
declare function NoAction(): Action;
...
```
 */
declare function ActionOverride(actor: ObjectPtr, action: Action): Action;
...
```
 */
declare function RandomFly(): Action;
 ...
 */
declare function FlyToPoint(point: Point, time: number): Action;

/**
 * This action sets the morale of the active creature.
 */
declare function MoraleSet(target: ObjectPtr, morale: number): Action;
...
```
 */
declare function MoraleInc(target: ObjectPtr, morale: number): Action;

/**
 * This action alters the morale of the target by the specified amount. The change amount can be positive or negative.
 */
declare function MoraleDec(target: ObjectPtr, morale: number): Action;
...
```
 */
declare function AttackOneRound(target: ObjectPtr): Action;
...
```
 */
declare function Shout(id: ShoutID): Action;
 ...
 */
declare function MoveToOffset(offset: Point): Action;
 ...
 */
declare function ForceSpell(target: ObjectPtr, spell: SpellID): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function ForceSpellPoint(target: Point, spell: SpellID): Action;
...
```
 */
declare function TakePartyGold(amount: number): Action;
...
```
 */
declare function GivePartyGold(amount: number): Action;
...
```
 */
declare function DropInventory(): Action;
...
```
 */
declare function StartCutScene(cutscene: string): Action;
...
```
 */
declare function StartCutSceneMode(): Action;
...
```
 */
declare function EndCutSceneMode(): Action;
...
```
 */
declare function ClearAllActions(): Action;
...
```
 */
declare function CutSceneId(object: ObjectPtr): Action;
 ...
 */
declare function AnkhegEmerge(): Action;
 ...
 */
declare function AnkhegHide(): Action;
...
```
 */
declare function FindTraps(): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function RandomTurn(): Action;
...
```
 */
declare function Kill(object: ObjectPtr): Action;
...
```
 */
declare function VerbalConstant(object: ObjectPtr, constant: SoundOff): Action;
...
```
 */
declare function ClearActions(object: ObjectPtr): Action;
...
```
 */
declare function AttackReevaluate(target: ObjectPtr, reevaluationperiod: number): Action;
...
```
 */
declare function LockScroll(): Action;
...
```
 */
declare function UnlockScroll(): Action;

/**
 * 
 */
declare function StartDialogue(dialogfile: string, target: ObjectPtr): Action;
...
```
 */
declare function StartDialog(dialogfile: string, target: ObjectPtr): Action;

/**
 * 
 */
declare function SetDialogue(dialogfile: string): Action;
...
```
 */
declare function SetDialog(dialogfile: string): Action;

/**
 * 
 */
declare function PlayerDialogue(target: ObjectPtr): Action;
 ...
 */
declare function PlayerDialog(target: ObjectPtr): Action;
 ...
 * This action is used by the engine internally. An object id is expected in the in1 parameter.
 */
declare function UseDoor(): Action;
...
```
 */
declare function OpenDoor(object: ObjectPtr): Action;
...
```
 */
declare function CloseDoor(object: ObjectPtr): Action;
 ...
 */
declare function PickLock(object: ObjectPtr): Action;
...
```
 */
declare function Polymorph(animationtype: Animate): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function RemoveSpell(spell: SpellID): Action;
 ...
 */
declare function BashDoor(object: ObjectPtr): Action;
...
```
 */
declare function EquipMostDamagingMelee(): Action;
...
```
 */
declare function StartStore(store: string, target: ObjectPtr): Action;
 ...
 */
declare function ChangeAIType(object: ObjectPtr): Action;
...
```
 */
declare function ChangeEnemyAlly(object: ObjectPtr, value: EA): Action;
...
```
 */
declare function ChangeGeneral(object: ObjectPtr, value: General): Action;
...
```
 */
declare function ChangeRace(object: ObjectPtr, value: Race): Action;
...
```
 */
declare function ChangeClass(object: ObjectPtr, value: Class): Action;
...
```
 */
declare function ChangeSpecifics(object: ObjectPtr, value: Specific): Action;
...
```
 */
declare function ChangeGender(object: ObjectPtr, value: Gender): Action;
...
```
 */
declare function ChangeAlignment(object: ObjectPtr, value: Align): Action;
...
```
 */
declare function GiveOrder(object: ObjectPtr, order: number): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function ApplySpell(target: ObjectPtr, spell: SpellID): Action;
...
```
 */
declare function IncrementChapter(resref: string): Action;
...
```
 */
declare function ReputationSet(reputation: number): Action;
...
```
 */
declare function ReputationInc(reputation: number): Action;
...
```
 */
declare function SetNumTimesTalkedTo(num: number): Action;
...
```
 */
declare function StartMovie(resref: string): Action;
...
```
 */
declare function Interact(object: ObjectPtr): Action;
...
```
 */
declare function GiveGoldForce(amount: number): Action;

/**
 * This action sets the open/closed graphic of a tile in a WED file.
 */
declare function ChangeTileState(tile: ObjectPtr, state: boolean): Action;
...
```
 */
declare function EquipRanged(): Action;

/**
 * 
 */
declare function SetLeavePartyDialogueFile(): Action;
...
```
 */
declare function SetLeavePartyDialogFile(): Action;
 ...
 */
declare function EscapeAreaDestroy(delay: number): Action;
 ...
 */
declare function TriggerActivation(object: ObjectPtr, state: boolean): Action;

/**
 * 
 */
declare function DialogueInterrupt(state: boolean): Action;
 ...
 */
declare function DialogInterrupt(state: boolean): Action;
 ...
 */
declare function MoveToObjectFollow(object: ObjectPtr): Action;

/**
 * 
 */
declare function ReallyForceSpellRES(spell: SplRef, target: ObjectPtr): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function ReallyForceSpell(target: ObjectPtr, spell: SpellID): Action;
 ...
 */
declare function RunAwayFromNoInterrupt(creature: ObjectPtr, time: number): Action;
 ...
 */
declare function SetMasterArea(name: string): Action;

/**
 * This action shows the ending credits.
 */
declare function EndCredits(): Action;
 ...
 */
declare function StartMusic(slot: number, flags: MFlags): Action;
...
```
 */
declare function JoinParty(): Action;

/**
 * This action saves the game in the specified save slot.
 */
declare function SaveGame(slot: number): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function SpellNoDec(target: ObjectPtr, spell: SpellID): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function SpellPointNoDec(target: Point, spell: SpellID): Action;
 ...
 */
declare function Lock(object: ObjectPtr): Action;

/**
 * This action will unlock the specified door/container.
 */
declare function Unlock(object: ObjectPtr): Action;
 ...
 * 
 */
declare function StartDialogNoSet(object: ObjectPtr): Action;
 ...
 */
declare function StartDialogueNoSet(object: ObjectPtr): Action;

/**
 * This action displays a textscreen, showing text and graphics from the specified 2DA file.
 */
declare function TextScreen(textlist: string): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function RandomWalkContinuous(): Action;

/**
 * This action will highlight the specified secret door in purple, to indicate it has been detected.
 */
declare function DetectSecretDoor(object: ObjectPtr): Action;
 ...
 */
declare function FadeToColor(point: Point, blue: number): Action;
 ...
 */
declare function FadeFromColor(point: Point, blue: number): Action;
 ...
 */
declare function WaitWait(time: number): Action;
 ...
 */
declare function MoveToPointNoInterrupt(point: Point): Action;
 ...
 */
declare function MoveToObjectNoInterrupt(object: ObjectPtr): Action;
 ...
 */
declare function SpawnPtActivate(object: ObjectPtr): Action;
...
```
 */
declare function LeaveParty(): Action;
 ...
 */
declare function SpawnPtDeactivate(object: ObjectPtr): Action;
 ...
 */
declare function SpawnPtSpawn(object: ObjectPtr): Action;
...
```
 */
declare function FollowObjectFormation(object: ObjectPtr, formation: number, position: number): Action;
 ...
 */
declare function TakeItemListPartyNum(resref: string, num: number): Action;
 ...
 */
declare function FaceObject(object: ObjectPtr): Action;
 ...
 */
declare function MoveGlobalObjectOffScreen(object: ObjectPtr, target: ObjectPtr): Action;
 ...
 */
declare function StorePartyLocations(): Action;
 ...
 */
declare function RestorePartyLocations(): Action;
 ...
 */
declare function MoveToCenterOfScreen(notinterruptablefor: number): Action;
 ...
 */
declare function SetTokenObject(token: string, object: ObjectPtr): Action;

/**
 * This action updates various tokens based on the specified object.
 */
declare function SetGabber(object: ObjectPtr): Action;
...
```
 */
declare function PickPockets(target: ObjectPtr): Action;
 ...
 */
declare function ContainerEnable(object: ObjectPtr, bool: boolean): Action;
 ...
 */
declare function ScreenShake(point: Point, duration: number): Action;
...
```
 */
declare function AddGlobals(name: string, name2: string): Action;
 ...
 */
declare function FillSlot(slot: Slots): Action;

/**
 * This action adds the specified amount of XP onto the specified object.
 */
declare function AddXPObject(object: ObjectPtr, xp: number): Action;
...
```
 */
declare function PlaySound(sound: string): Action;
 ...
 */
declare function DestroyGold(gold: number): Action;

/**
 * This action stores a "home" location into memory for a creature. The location is not saved.
 */
declare function SetHomeLocation(point: Point): Action;
 ...
 */
declare function CopyGroundPilesTo(resref: string, location: Point): Action;

/**
 * 
 */
declare function DialogForceInterrupt(object: ObjectPtr): Action;
 ...
 */
declare function DialogueForceInterrupt(object: ObjectPtr): Action;

/**
 * 
 */
declare function StartDialogueInterrupt(dialogfile: string, target: ObjectPtr): Action;

/**
 * 
 */
declare function StartDialogInterrupt(dialogfile: string, target: ObjectPtr): Action;

/**
 * 
 */
declare function StartDialogNoSetInterrupt(object: ObjectPtr): Action;

/**
 * 
 */
declare function StartDialogueNoSetInterrupt(object: ObjectPtr): Action;
...
```
 */
declare function ProtectPoint(target: Point, range: number): Action;

/**
 * This action changes the animation of the active creature to match the animation of the target object.
 */
declare function PolymorphCopy(object: ObjectPtr): Action;

/**
 * This action plays the specified sound from the character's soundset.
 */
declare function VerbalConstantHead(object: ObjectPtr, constant: SoundOff): Action;
 ...
 */
declare function CreateVisualEffect(object: string, location: Point): Action;
 ...
 */
declare function CreateVisualEffectObject(dialogfile: string, target: ObjectPtr): Action;
 ...
 */
declare function AddKit(kit: Kit): Action;

/**
 * This action can be used to manually start the combat counter.
 */
declare function StartCombatCounter(): Action;
 ...
 */
declare function EscapeAreaNoSee(): Action;
 ...
 */
declare function EscapeAreaObject(object: ObjectPtr): Action;
...
```
 */
declare function RemoveTraps(trap: ObjectPtr): Action;
 ...
 */
declare function DestroyAllDestructableEquipment(): Action;

/**
 * This action changes a Paladin to a Fallen Paladin.
 */
declare function RemovePaladinHood(): Action;

/**
 * This action changes a Ranger to a Fallen Ranger.
 */
declare function RemoveRangerHood(): Action;
 ...
 */
declare function AddSuperKit(kit: Kit): Action;
...
```
 */
declare function RunAwayFrom(creature: ObjectPtr, time: number): Action;

/**
 * 
 */
declare function PlayDeadInterruptible(time: number): Action;
 ...
 */
declare function PlayDeadInterruptable(time: number): Action;
 ...
 */
declare function MoveGlobalObject(object: ObjectPtr, target: ObjectPtr): Action;
 ...
 * 
 */
declare function StartDialogOverride(dialogfile: string, target: ObjectPtr, unused0: number, unused1: number, converseasitem: number): Action;
 ...
 */
declare function StartDialogOverride(dialogfile: string, target: ObjectPtr): Action;
 ...
 */
declare function BattleSong(): Action;
 ...
 */
declare function ApplyDamage(object: ObjectPtr, amount: number, type: DMGtype): Action;
 ...
 */
declare function BanterBlockTime(time: number): Action;
...
```
 */
declare function Attack(target: ObjectPtr): Action;
 ...
 */
declare function BanterBlockFlag(state: boolean): Action;
 ...
 */
declare function AmbientActivate(object: ObjectPtr, state: boolean): Action;
 ...
 */
declare function AttachTransitionToDoor(global: string, object: ObjectPtr): Action;

/**
 * This action applies a percentage damage (of the specified damage type) to the target object.
 */
declare function ApplyDamagePercent(object: ObjectPtr, amount: number, type: DMGtype): Action;

/**
 * This action acts as a shortcut for SetGlobal(). The action can only set global variables.
 */
declare function SG(name: string, num: number): Action;
 ...
 */
declare function DemoEnd(): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function Spell(target: ObjectPtr, spell: SpellID): Action;
 ...
 */
declare function StateOverrideTime(time: number): Action;

/**
 * 
 */
declare function StateOverrideFlag(state: boolean): Action;

/**
 * This action modifies the probability of a daytime rest interruption (by modifying fields in the ARE file).
 */
declare function SetRestEncounterProbabilityDay(prob: number): Action;

/**
 * This action modifies the probability of a night-time rest interruption (by modifying fields in the ARE file).
 */
declare function SetRestEncounterProbabilityNight(prob: number): Action;
 ...
 */
declare function SoundActivate(object: ObjectPtr, state: boolean): Action;

/**
 * The action plays the specified song. Values are from [SONGLIST.2DA]({{ 2da }}/songlist.htm).
 */
declare function PlaySong(song: number): Action;

/**
 * 
 */
declare function ForceSpellRangeRES(res: string, target: ObjectPtr): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function ForceSpellRange(target: ObjectPtr, spell: SpellID): Action;

/**
 * 
 */
declare function ForceSpellPointRangeRES(res: string, target: Point): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function ForceSpellPointRange(target: Point, spell: SpellID): Action;
 ...
 */
declare function SetAreaRestFlag(canrest: number): Action;
 ...
 */
declare function FakeEffectExpiryCheck(object: ObjectPtr, ticks: number): Action;
 ...
 */
declare function SetBeenInPartyFlags(): Action;

/**
 * This action returns the player to the game start screen.
 */
declare function GoToStartScreen(): Action;
 ...
 */
declare function ExitPocketPlane(): Action;
 ...
 */
declare function AddXP2DA(column: string): Action;
 ...
 */
declare function AddAreaType(type: AreaType): Action;
 ...
 */
declare function RemoveAreaType(type: AreaType): Action;
 ...
 */
declare function AddAreaFlag(type: AreaFlag): Action;
 ...
 */
declare function RemoveAreaFlag(type: AreaFlag): Action;

/**
 * This action instructs the active creature to start the specified dialog with the specified target. The dialog can be initiated from a distance and must have at least one state with all its top level conditions true else it will not initiate. The active creature name will not appear as the dialog attribution.
 */
declare function StartDialogNoName(dialogfile: string, target: ObjectPtr): Action;
 ...
 */
declare function MakeGlobal(): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function ReallyForceSpellPoint(target: Point, spell: SpellID): Action;

/**
 * 
 */
declare function CutAllowScripts(bool: boolean): Action;

/**
 * 
 */
declare function SetCursorState(bool: boolean): Action;
 ...
 */
declare function SetCutSceneLite(bool: boolean): Action;
 ...
 */
declare function SwingOnce(): Action;
 ...
 */
declare function StaticSequence(object: ObjectPtr, sequence: number): Action;

/**
 * This action changes the palette (BMP file) of the specified animation object.
 */
declare function StaticPalette(palette: string, object: ObjectPtr): Action;
 ...
 */
declare function MoveToExpansion(): Action;
 ...
 */
declare function StartRainNow(): Action;
 ...
 */
declare function SetSequence(sequence: Seq): Action;
...
```
 */
declare function SetupWish(column: number, count: number): Action;

/**
 * 
 */
declare function SetupWishObject(creature: ObjectPtr, count: number): Action;
...
```
 */
declare function Continue(): Action;
...
```
 */
declare function Recoil(): Action;
...
```
 */
declare function PlayDead(time: number): Action;
...
```
 */
declare function Formation(leader: ObjectPtr, offset: Point): Action;
...
```
 */
declare function JumpToPoint(target: Point): Action;
 ...
 */
declare function MoveViewPoint(target: Point, scrollspeed: Scroll): Action;
...
```
 */
declare function MoveViewObject(target: ObjectPtr, scrollspeed: Scroll): Action;
...
```
 */
declare function ChangeAIScript(scriptfile: string, level: ScrLev): Action;
...
```
 */
declare function StartTimer(id: number, time: number): Action;
 ...
 */
declare function SendTrigger(target: ObjectPtr, triggernum: number): Action;
...
```
 */
declare function Wait(time: number): Action;
...
```
 */
declare function UndoExplore(): Action;
...
```
 */
declare function Explore(): Action;
...
```
 */
declare function DayNight(timeofday: Time): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function Weather(weather: WeatherID): Action;
...
```
 */
declare function CallLightning(target: ObjectPtr): Action;
 ...
 */
declare function VEquip(item: number): Action;
 ...
 * 
 */
declare function Dialog(object: ObjectPtr): Action;
...
```
 */
declare function Dialogue(object: ObjectPtr): Action;
...
```
 */
declare function SmallWait(time: number): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function RandomWalk(): Action;
...
```
 */
declare function SetInterrupt(state: boolean): Action;
...
```
 */
declare function ProtectObject(target: ObjectPtr, range: number): Action;
...
```
 */
declare function SelectWeaponAbility(weaponnum: Slots, abilitynum: number): Action;
...
{% endcapture %} {% include note.html %}
 */
declare function SpellPoint(target: Point, spell: SpellID): Action;
